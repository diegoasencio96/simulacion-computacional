...
to correr
  repeat cantidad[
    ask patches[
      let n_vecinos count neighbors with [
        pcolor = black
      ]
      ifelse pcolor = white and n_vecinos = 3 [
        set celula black
      ]
      [
        ifelse pcolor = black and (n_vecinos = 2 or n_vecinos = 3) [
          set celula black
        ]
        [
          set celula white
...
952
387
Coded by @diegoasencio96 on GitHub!
13
0.0
1
